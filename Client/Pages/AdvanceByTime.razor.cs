...
{
    public partial class AdvanceByTime
    {
        ...
        public AdvanceByTime(ApplicationContext context, IApartmentsService apartmentsService, IActivitiesService activitiesService, IAreasService areasService, IElementsService elementsService, ISubElementsService subElementsService, IProgressReportService progressReportService,
        ...
        public async Task ShowReportAndHideApartment()
        {
            ...
            var pdf = await _reportesService.PostReporteTiempoAsync(data);
