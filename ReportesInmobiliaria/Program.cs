...
app.MapPost("/Lessor", async (SharedLibrary.Models.Lessor lessor, ILessorService _lessorService) =>
{
    try
    {
...
app.MapPost("/Tenant", async (SharedLibrary.Models.Tenant tenant, ITenantService _tenantService) =>
{
    try
    {
