...
namespace ReportesObra.Interfaces
{
    ...
    {
        Task<byte[]> GetReporteDetalles(int idBuilding, List<int> idApartments, List<int>? idAreas, List<int> idActivities, List<int> idElements, List<int>? idSubElements);
        ...
        Task<List<ActivityProgressByAparment>> GetAparmentsByActivity(int? idApartment);
