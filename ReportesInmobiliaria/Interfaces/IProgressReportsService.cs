...
namespace ReportesObra.Interfaces
{
    public interface IProgressReportsService
    {
        ...
        Task<List<ProgressReport>?> GetProgressReportsDetailedAsync(int idBuilding, List<int>? idApartments, List<int>? idAreas, List<int>? idElements, List<int>? idSubElements, List<int>? idActivities);
